"""Training utilities for the ASL words dataset."""
...
def _default_output_path() -> Path:
    ...
    return repo_root / "models" / "asl-words-detector.pt"
...
class ASLWordsTrainingConfig:
    """Configuration required to train the ASL words YOLO model."""
...
def train_asl_words(config: ASLWordsTrainingConfig) -> Path:
    """Train a YOLO model on the ASL words dataset and return the weights path."""
...
def _parse_args() -> argparse.Namespace:
    defaults = ASLWordsTrainingConfig()

    parser = argparse.ArgumentParser(description="Train YOLO on the ASL words dataset.")
...
def main() -> None:
    ...
    weights_path = train_asl_words(config)
